	...
	<div class="grid">
		<div class="col-12 lg:col-6 xl:col-3">
			<div class="card mb-0">
				<div class="flex justify-content-between mb-3">
					<div>
						<span class="block text-500 font-medium mb-3">Transacciones</span>
				...
				<span class="text-500">Desde ultimo Ingreso</span>
			</div>
		</div>
		<div class="col-12 lg:col-6 xl:col-3">
			<div class="card mb-0">
				...
				<span class="text-500">Desde inicio de Turno</span>
			</div>
		</div>
		<div class="col-12 lg:col-6 xl:col-3">
			<div class="card mb-0">
		...
		<div class="col-12 lg:col-6 xl:col-3">
			<div class="card mb-0">
				<div class="flex justify-content-between mb-3">
					<div>
						<span class="block text-500 font-medium mb-3">Feedbacks</span>
	...
	<div class="col-12 xl:col-6">
		<div class="card">
			...
			<DataTable :value="products" :rows="5" :paginator="true" responsiveLayout="scroll">
				...
				<Column field="name" header="Nombre Plato" :sortable="true" style="width:35%"></Column>
				<Column field="price" header="Precio" :sortable="true" style="width:35%">
					<template #body="slotProps">
						{{formatCurrency(slotProps.data.price)}}
					</template>
				</Column>
				<Column field="price" header="Precio Delivery" :sortable="true" style="width:35%">
					<template #body="slotProps">
						{{formatCurrency(slotProps.data.price)}}
					</template>
				</Column>
